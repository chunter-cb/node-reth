...
use aa_utils::random::random_bytes_array;
...
impl Eip7702Auth {
    ...
    pub fn validate(&self, _signer: Address) -> anyhow::Result<()> {
        let _signed_auth = SignedAuthorization::from(self.clone());
        // TODO: validate the authorization signature
        // The method to recover the signer may have changed in the newer alloy version
        Ok(())
    }
}
