...
use aa_provider::{DAGasProvider, EntryPoint, EvmProvider, FeeEstimator};
use aa_types::{
    chain::ChainSpec,
    da::DAGasData,
...
#[cfg_attr(feature = "test-utils", automock(type UO = aa_types::v0_6::UserOperation;))]
...
mod tests {
    ...
    use aa_provider::{MockEntryPointV0_6, MockEvmProvider, MockFeeEstimator};
    use aa_types::{
