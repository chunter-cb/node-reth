...
use aa_contracts::v0_6::IEntryPoint::{
    BeforeExecution, UserOperationEvent, UserOperationRevertReason,
};
use aa_provider::{Log, TransactionReceipt};
use aa_types::{chain::ChainSpec, v0_6::UserOperation};
...
impl EntryPointEvents for EntryPointFiltersV0_6 {
    ...
    fn get_user_operations_from_tx_data(tx_data: Bytes, chain_spec: &ChainSpec) -> Vec<Self::UO> {
        let uos_per_agg = aa_provider::decode_v0_6_ops_from_calldata(chain_spec, &tx_data);
