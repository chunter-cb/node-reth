...
use alloy_primitives::{Address, Bytes, TxHash, B256, U256, keccak256};
    ...
    AP: AlloyProvider,
{
    ...
    async fn get_code_hash(
        ...
        let code_hashes = call.call().await?;
        
        // Hash together all code hashes
