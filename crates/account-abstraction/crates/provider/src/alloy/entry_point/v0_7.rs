...
use aa_utils::authorization_utils;
...
impl TryFrom<ExecutionResultV0_7> for ExecutionResult {
    ...
    fn try_from(result: ExecutionResultV0_7) -> Result<Self, Self::Error> {
        let account = aa_types::parse_validation_data(result.accountValidationData);
        let paymaster = aa_types::parse_validation_data(result.paymasterValidationData);
