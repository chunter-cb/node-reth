...
use aa_utils::{guard_timer::CustomTimerGuard, math};
use tokio::join;
    ...
    F: FeeEstimator,
{
    ...
    async fn estimate_op_gas(
        ...
        let pre_verification_gas = if op.pre_verification_gas.is_some_and(|pvg| pvg != 0) {
            ...
            aa_types::increase_required_pvg_with_calldata_floor_gas(
                &op_with_gas,
...
mod tests {
    ...
    use aa_contracts::common::EstimationTypes::TestCallGasResult;
    use aa_provider::{
        ExecutionResult, MockEntryPointV0_7, MockEvmProvider, MockFeeEstimator,
    };
    use aa_types::v0_7::UserOperationOptionalGas;
